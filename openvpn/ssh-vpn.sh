...
wget -O /etc/pam.d/common-password "${REPO}file/password.txt"
...
wget -O /etc/nginx/nginx.conf "${REPO}configuration/nginx.conf"
...
cd
cd
wget -O /usr/bin/badvpn-udpgw ${REPO}openvpn/badvpn-udpgw && chmod +x  /usr/bin/badvpn-udpgw
#system badvpn 7300
wget -O /etc/systemd/system/svr-7300.service ${REPO}openvpn/svr-7300.service && chmod +x  /etc/systemd/system/svr-7300.service
#system badvpn 7200
wget -O /etc/systemd/system/svr-7200.service ${REPO}openvpn/svr-7200.service && chmod +x  /etc/systemd/system/svr-7200.service
#system badvpn 7100
wget -O /etc/systemd/system/svr-7100.service ${REPO}openvpn/svr-7100.service && chmod +x  /etc/systemd/system/svr-7100.service
...
#installer OPH
wget ${REPO}websocket/ohp.sh && chmod +x ohp.sh && ./ohp.sh
#installer openvpn
