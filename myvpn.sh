...
CDNF="https://raw.githubusercontent.com/rizkihdyt6/colong/main/"
...
clear
echo -e "${red}    ♦️${NC} ${green} CUSTOM SETUP ALL DOMAIN VPS     ${NC}"
...
#exp
cd /usr/bin
wget -O xp "${REPO}file/xp.sh"
chmod +x xp
sleep 1
wget -q -O /usr/bin/notramcpu "${REPO}file/notramcpu" && chmod +x /usr/bin/notramcpu
